            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-card mb-6">
              <table className="w-full">
                <thead className="bg-brand-light-gray/50">
                  <tr>
                    <th className="text-left p-4 text-label-md text-brand-gray">
                      {t("cart.product")}
                    </th>
                    <th className="text-center p-4 text-label-md text-brand-gray">
                      {t("cart.quantity")}
                    </th>
                    <th className="text-right p-4 text-label-md text-brand-gray">
                      {t("cart.total")}
                    </th>
                    <th className="w-10" />
                  </tr>
                ...
                <tbody>
                  {items.map((item, index) => (
                    <tr key={`${item.id}-${item.size}-${index}`} className="border-t border-brand-light-gray">
                      <td className="p-4 text-body-sm text-brand-dark">
                        {item.name}
                      </td>
              ...
              <div className="p-4 border-t border-brand-light-gray flex justify-between items-center">
                <span className="text-title-md font-bold text-brand-dark">
                  {t("cart.total")}
                </span>
